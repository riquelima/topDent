...
export const ConfigurationsPage = (): JSX.Element => {
  ...
  return (
    <div className="space-y-8">
      ...
      <Card title="Gerenciar Procedimentos Definidos" className="bg-[#1a1a1a]" titleClassName="text-white">
        <div className="mb-6 text-right">
          <Button onClick={() => handleOpenProcedureModal()} leftIcon={<UserPlusIcon />}> {/* Using UserPlus for consistency, or BriefcaseIcon */}
      ...
      <Card title="Gerenciar Lembretes (Notas Globais)" className="bg-[#1a1a1a]" titleClassName="text-white">
